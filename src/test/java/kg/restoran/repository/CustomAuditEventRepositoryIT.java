...
import kg.restoran.config.audit.AuditEventConverter;
import kg.restoran.domain.PersistentAuditEvent;
...
import static kg.restoran.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
