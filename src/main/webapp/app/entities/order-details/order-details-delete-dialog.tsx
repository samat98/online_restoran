...
export const OrderDetailsDeleteDialog = (props: IOrderDetailsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineRestoranApp.orderDetails.delete.question">
        <Translate contentKey="onlineRestoranApp.orderDetails.delete.question" interpolate={{ id: orderDetailsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-orderDetails" color="danger" onClick={confirmDelete}>
