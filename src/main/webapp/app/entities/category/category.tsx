  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="onlineRestoranApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="onlineRestoranApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
        ...
        {categoryList && categoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="onlineRestoranApp.category.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="onlineRestoranApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
