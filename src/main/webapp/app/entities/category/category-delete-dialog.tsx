...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineRestoranApp.category.delete.question">
        <Translate contentKey="onlineRestoranApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
