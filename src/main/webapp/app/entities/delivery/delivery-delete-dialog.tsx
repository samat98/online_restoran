...
export const DeliveryDeleteDialog = (props: IDeliveryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineRestoranApp.delivery.delete.question">
        <Translate contentKey="onlineRestoranApp.delivery.delete.question" interpolate={{ id: deliveryEntity.id }}>
